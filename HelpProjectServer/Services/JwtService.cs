...
namespace HelpProjectServer.Services
{
    public class JwtService
    {
        ...
        private TimeSpan TokenNumMinutesToExtend = new TimeSpan(0, 30, 0);
        private TimeSpan TokenMaxMinutesSession = new TimeSpan(1, 0, 0);
        ...
        public string GenerateToken(string tokenPrimaryValue, string uRole)
        {
